...
public class Practice11Test {
	...
	@Test
	public void should_computer_be_notified_when_any_class_it_teaches_assigned_a_leader() throws Exception {
		LinkedList<practice11.Klass> linkedList = new LinkedList<Klass>();
		linkedList.add(klass2);
	...
	@Test
	public void should_computer_and_teacher_be_notified_when_any_class_it_teaches_assigned_a_leader() throws Exception {
		LinkedList<practice11.Klass> linkedList = new LinkedList<Klass>();
		linkedList.add(klass2);
		Computer computer = new Computer("w10",linkedList);
		Teacher tom = new Teacher(1, "Tom", 21, linkedList);
